4. Env Preset: 변환 규칙 모음
    ...
    1) preset
        -   여러 플러그인 변호나 규칙을 하나 번에 적용하기 위해서 관련 플러그인을 모아 놓은 것
        -   종류
            ...
            등 다양하다.
        - ECMAPScript Preset은 Env Preset(preset-env, ECMAPScript level13)이다.
    ...
    4) Env Preset 설정
        - 타켓 브라우저 설정하는 방식
        - 브라우저별 es6 호환성 테이블(https://kangax.github.io/compat-table)
